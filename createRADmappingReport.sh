...
rm indInfoAdvSorted indInfoAdv.txt sortedReport indInfoSorted sorted_indInfoMin10reads.txt indInfoMin10reads.txt indInfo.txt \
	lociMin10reads.txt contigs.txt report.txt 
